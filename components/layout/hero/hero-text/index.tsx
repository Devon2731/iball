...
export function HeroWords() {
  return (
    <div className="mb-3 ms-4 flex items-center justify-center lg:left-1/3 lg:top-1/2">
      ...
      <p className="kode-mono-lab mt-2 text-balance pe-2 ps-2 text-3xl text-black md:text-5xl xl:pe-4 xl:text-7xl dark:text-white">
        WELCOME
      </p>
      ...
      <TextGenerateEffect words={The} className="pe-2 ps-2" />
      <TextGenerateEffect words={Lab} className="ps-2" />
    </div>
  );
}
